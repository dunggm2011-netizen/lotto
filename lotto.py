...
# ================================================================
USER_ID = "11575993"        # 👈 Thay bằng userId clone của mày
SECRET_KEY = "cc8f1ddcdd33163122073bd3cacaf80c825624b256090d60fda4dc2bf5fef0e5"     # 👈 Thay bằng secretKey clone của mày
# ================================================================

# ==================== CẤU HÌNH RENDER ====================
BOT_TOKEN = os.environ.get("8385677064:AAHS5ZqmV9QPka3I1t84lyysLzLsLTp3N6g")
ADMIN_IDS = [int(x) for x in os.environ.get("ADMIN_IDS", "7564889663").split(",")]
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "https://lotto.onrender.com/webhook")
...
def generate_key(days: int) -> str:
    """Tạo key ngẫu nhiên có thời hạn theo ngày"""
...
def handle_callback(call):
    ...
    # Kiểm tra key cho user thường
    if user_id not in ADMIN_IDS:
        # Cho phép các action cơ bản
        pass
